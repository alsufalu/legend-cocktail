...
(function() {
  ...
  style.textContent = `
    /* Remove forced capitalization — display text exactly as typed */
    input, select, textarea, label, td, th,
    .input, .cardBtn strong, .cardBtn small,
    .ingredientResult, .ingredientSelected,
    .sectionTitle, .savedMenuCard .menuCardName,
    .batchCocktailCard .bcName, .batchResult h3,
    .batchResultRow .ingName { text-transform: none !important; }
